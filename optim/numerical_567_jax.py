...
try:
    ...
    def _loss_fn(lengths, alpha, task_poses, init_joints, link_radius, zero_link_weight):
        """
        lengths:         [n_links, 2]
        alpha:           [n_links, 1]
        task_poses:      [N, 4, 4]
        ...
        return jnp.mean(dists) + zero_link_weight * zero_link_penalty, (morph, optimal_joints)
