...
# -----------------------------------------------------------------------------
# Minimal kinematics.py subset
# -----------------------------------------------------------------------------

def transformation_matrix(alpha: Tensor, a: Tensor, d: Tensor, theta: Tensor) -> Tensor:
    """
...
def forward_kinematics(mdh: Tensor, theta: Tensor) -> Tensor:
    """
