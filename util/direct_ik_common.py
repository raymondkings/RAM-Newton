...
from util.self_collision import get_capsules, get_joint_limits
...
def _compute_joint_bounds(mdh: Tensor, n_joints: int) -> tuple[Tensor, Tensor]:
    """Per-joint lower/upper bounds from morphology self-collision limits.
